...
class PageAddServicesController extends Controller
{
    ...
    {
        return $content
            ->header(trans('Дополнительные услуги'))
    ...
    {
        $grid = new Grid(new PageAddServices);
    ...
    {
        $show = new Show(PageAddServices::findOrFail($id));
    ...
    {
        $form = new Form(new PageAddServices);
