...
class PageIndividualController extends Controller
{
    ...
    {
        $grid = new Grid(new PageIndividual);
    ...
    {
        $show = new Show(PageIndividual::findOrFail($id));
    ...
    {
        $form = new Form(new PageIndividual);
