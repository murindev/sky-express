...
<fieldset x-data="tabCalculator()">
    <label data-type="prompt" @click.outside="from = ''">
    ...
    <button class="accent" @click="submitForm()">Рассчитать стоимость доставки</button>
...
<script>
    ...
    function tabCalculator() {
        return {
            ...
            weight: 0,
            submitForm() {
                this.model = `${this.length}мм x ${this.width}мм x ${this.height}мм x ${this.weight}кг`
                this.active = false
            }
        }
    }
